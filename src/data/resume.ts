...
export const projects: Project[] = [
  {
    ...
    heroScreenshot: { light: '/screenshots/rag-platform/dark/tenants.png', dark: '/screenshots/rag-platform/dark/tenants.png' },
    screenshots: [
  ...
  },
  {
    ...
    heroScreenshot: { light: '/screenshots/mcp-agent/dark/chat.png', dark: '/screenshots/mcp-agent/dark/chat.png' },
    screenshots: [
  ...
  },
  {
    ...
    heroScreenshot: { light: '/screenshots/document-intelligence/dark/entities.png', dark: '/screenshots/document-intelligence/dark/entities.png' },
    screenshots: [
  ...
  },
  {
    ...
    heroScreenshot: { light: '/screenshots/llmops/dark/dashboard.png', dark: '/screenshots/llmops/dark/dashboard.png' },
    screenshots: [
      { light: '/screenshots/llmops/dark/dashboard.png', dark: '/screenshots/llmops/dark/dashboard.png', alt: 'Dashboard — 2,760 requests, $3.55 cost, 30-day traffic chart' },
      { light: '/screenshots/llmops/dark/experiments.png', dark: '/screenshots/llmops/dark/experiments.png', alt: 'A/B experiments with completion status and variant comparison' },
      { light: '/screenshots/llmops/dark/deployments.png', dark: '/screenshots/llmops/dark/deployments.png', alt: 'Canary deployment pipeline — staging, canary (25%), production' },
      { light: '/screenshots/llmops/dark/prompts.png', dark: '/screenshots/llmops/dark/prompts.png', alt: 'Prompt template management with application selector' },
    ],
