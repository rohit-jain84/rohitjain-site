...
export const projects: Project[] = [
  {
    ...
    heroScreenshot: { light: '/screenshots/rag-platform/dark/tenants.png', dark: '/screenshots/rag-platform/light/tenants.png' },
    screenshots: [
  ...
  },
  {
    ...
    heroScreenshot: { light: '/screenshots/mcp-agent/dark/chat.png', dark: '/screenshots/mcp-agent/light/chat.png' },
    screenshots: [
  ...
  },
  {
    ...
    heroScreenshot: { light: '/screenshots/document-intelligence/dark/entities.png', dark: '/screenshots/document-intelligence/light/entities.png' },
    screenshots: [
