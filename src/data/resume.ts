...
export const projects: Project[] = [
  {
    ...
    heroScreenshot: { light: '/screenshots/rag-platform/dark/query.png', dark: '/screenshots/rag-platform/light/query.png' },
    screenshots: [
      { light: '/screenshots/rag-platform/dark/query.png', dark: '/screenshots/rag-platform/light/query.png', alt: 'Query playground with citations and latency breakdown' },
      { light: '/screenshots/rag-platform/dark/evaluation.png', dark: '/screenshots/rag-platform/light/evaluation.png', alt: 'RAGAS evaluation dashboard with faithfulness and relevancy metrics' },
      { light: '/screenshots/rag-platform/dark/health.png', dark: '/screenshots/rag-platform/light/health.png', alt: 'Health dashboard — PostgreSQL, Qdrant, Redis status' },
      { light: '/screenshots/rag-platform/dark/tenants.png', dark: '/screenshots/rag-platform/light/tenants.png', alt: 'Tenant management — API key provisioning, rate limits' },
      { light: '/screenshots/rag-platform/dark/documents.png', dark: '/screenshots/rag-platform/light/documents.png', alt: 'Document management with drag-and-drop upload' },
    ],
  ...
  },
  {
    ...
    heroScreenshot: { light: '/screenshots/document-intelligence/dark/dashboard.png', dark: '/screenshots/document-intelligence/light/dashboard.png' },
    screenshots: [
      { light: '/screenshots/document-intelligence/dark/dashboard.png', dark: '/screenshots/document-intelligence/light/dashboard.png', alt: 'Dashboard with document stats, quick search, and recent documents' },
      { light: '/screenshots/document-intelligence/dark/search.png', dark: '/screenshots/document-intelligence/light/search.png', alt: 'Hybrid search across document collections' },
      { light: '/screenshots/document-intelligence/dark/entities.png', dark: '/screenshots/document-intelligence/light/entities.png', alt: 'Entity extraction dashboard showing NER results' },
    ],
  ...
  },
  {
    ...
    heroScreenshot: { light: '/screenshots/llmops/dark/dashboard.png', dark: '/screenshots/llmops/light/dashboard.png' },
    screenshots: [
      { light: '/screenshots/llmops/dark/dashboard.png', dark: '/screenshots/llmops/light/dashboard.png', alt: 'Dashboard — 2,760 requests, $3.55 cost, 30-day traffic chart' },
      { light: '/screenshots/llmops/dark/cost-analytics.png', dark: '/screenshots/llmops/light/cost-analytics.png', alt: 'Cost analytics with daily spend trend and request volume' },
      { light: '/screenshots/llmops/dark/experiments.png', dark: '/screenshots/llmops/light/experiments.png', alt: 'A/B experiments with completion status and variant comparison' },
      { light: '/screenshots/llmops/dark/deployments.png', dark: '/screenshots/llmops/light/deployments.png', alt: 'Canary deployment pipeline — staging, canary (25%), production' },
      { light: '/screenshots/llmops/dark/prompts.png', dark: '/screenshots/llmops/light/prompts.png', alt: 'Prompt template management with application selector' },
    ],
