        ...
        <header className="bg-surface-secondary border border-border-default rounded-2xl p-8 md:p-12 mb-12">
          ...
          {study.githubUrl && (
            <a
              ...
              className="inline-flex items-center gap-2 text-sm font-semibold text-text-secondary hover:text-brand-primary border border-border-default hover:border-brand-primary px-4 py-2 rounded-xl transition-colors"
            >
