            ...
            return (
              ...
              >
                ...
                <div className="px-6 py-4 border-t border-border-default flex gap-4">
                  ...
                  {project.githubUrl && (
                    <span
                      className="inline-flex items-center gap-1.5 text-sm font-semibold text-text-secondary hover:text-brand-primary border border-border-default hover:border-brand-primary px-3 py-1 rounded-lg transition-colors cursor-pointer"
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
